                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <div class="type-lb">
                                                        <p class="<?= $product->status == ProductStatus::SALE ? 'sale' : 'new' ?>"><?= $product->status ?></p>
                                                    </div>
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <a class="cart" href="?controller=shop&action=addItemToCart&productId=<?= $product->id ?>">Add to Cart</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4><?= $product->name ?></h4>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <p>Integer tincidunt aliquet nibh vitae dictum. In turpis sapien, imperdiet quis magna nec, iaculis ultrices ante.
                                                        Integer vitae suscipit nisi. Morbi dignissim risus sit amet orci porta, eget aliquam purus
                                                        sollicitudin. Cras eu metus felis. Sed arcu arcu, sagittis in blandit eu, imperdiet sit amet eros.
                                                        Donec accumsan nisi purus, quis euismod ex volutpat in.</p>
